...
<table>
				...
				<?php
					...
					echo '<td><label for="address">Table No.</label><input id="address" name="address" type="text" data-error=".errorTxt06"><div class="errorTxt06"></div></td>';   
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4" href="#" target="_blank">Enefsee</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Enefsee</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
    ...
    $("#formValidate").validate({
        ...
        messages: {
           ...
           address:{
                minlength: "Table No. must be atleast 10 characters long",		
            },		
           balance:{
